            ...
            <div className="px-5">
              ...
              <div className="flex gap-3">
                <div className="w-40 border rounded-md mt-6 bg-white">
                  <div className='w-5 h-5 bg-red-550 rounded-full float-right z-10 -right-2 -top-2 relative text-center text-white items-center flex justify-center text-xs'>{notify}</div>
                  <img
                  ...
                  />
                  <div className="text-center py-1.5 text-lg text-gray-500">
                    Fernando
                  </div>
                </div>
        ...
        <div className='w-full grid justify-center items-center'>
          <div className="px-32 py-5">
            <p className="text-gray-500 pl-4 text-xs mb-2">
              <a href="">Português (Brasil)</a> <a href="">English (US)</a> <a href="">Español Français (France)</a> <a href="">Italiano</a>
              <a href="">Deutsch</a> <a href="">العربية</a> <a href="">हिन्दी 中文(简体</a>) <a href="">日本語</a>
          ...
          <div className='px-32'>
            <p className='text-gray-500 text-xs text-justify '>
              ...
              empregoOculusPortalInstagramBoletimLocalCampanhas de arrecadação de
              fundosServiçosCentral de Informações de VotaçãoGruposSobreCriar
              anúncioCriar PáginaDesenvolvedoresCarreirasPrivacidadeCookiesEscolhas
              para anúnciosTermosAjudaConfiguraçõesRegistro de Atividades 
              <p className='py-4'>
                Meta ©
                2021
              </p>
